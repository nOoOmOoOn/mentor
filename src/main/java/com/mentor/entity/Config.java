...
import com.mentor.entity.base.BaseConfig;
...
public class Config extends BaseConfig {
	...
	public static class ConfigOrder {
		...
		public ConfigOrder(Date freeTime){
			this.setFreeTime(freeTime);
		}
		/**
		 * 免费天数
		 */
		public static String ORDER_FREE_DAYS = "order_free_days";
	...
	public static class ConfigMessageTemplate implements MessageTemplate {
		...
		public static ConfigMessageTemplate createForgotPasswordMessageTemplate(
				Map<String, String> map) {
			if (map == null
					|| StringUtils.isBlank(map
							.get(MESSAGE_FORGOTPASSWORD_SUBJECT))
					|| StringUtils
							.isBlank(map.get(MESSAGE_FORGOTPASSWORD_TEXT))) {
				// 信息不完整，返回null。
				return null;
			}
		...
		public static ConfigMessageTemplate createRegisterMessageTemplate(
				Map<String, String> map) {
			if (map == null
					|| StringUtils.isBlank(map.get(MESSAGE_REGISTER_SUBJECT))

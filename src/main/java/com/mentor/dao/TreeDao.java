...
public interface TreeDao {
	...
	List<Tree> getFathersByRank(Integer leftNum, Integer rightNum, Integer rankNum, Integer n);
	
	List<Tree> getChildrenByRank(Integer leftNum, Integer rightNum, Integer rankNum, Integer n);
	
	Integer getChildrenNumByRank(Integer leftNum, Integer rightNum, Integer rankNum, Integer n);
}
